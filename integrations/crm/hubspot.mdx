...
Start by connecting your Lago instance to a new HubSpot connection. You can create as many HubSpot connections as you need. Once a connection is live, activate the syncs and actions your use case requires.
...
Lago is now connected to HubSpot.
...
- `lago_tax_identification_number`: your customer's tax identification number in Lago (Companies only); and
...
| Lago Subscription Link             | string      | text       | false            |
...
| Lago Purchase Order Number                   | string | text              | false            |
...
| Lago Invoice URL                             | string | text              | false            |
| Lago Invoice Total Due Amount                | number | number            | false            |
