...
### Deploy Lago Scripts
1. Make sure the [oAuth feature is enabled](https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/section_157771482304.html#To-enable-OAuth-2.0-feature%3A) for your NetSuite instance;
2. Navigate to **Customization > Scripting > Scripts > Create a New Script**; and
2. Deploy the script for **All roles** and **All employees**.
