...
If a Lago customer is linked to a NetSuite customer, Lago syncs invoices to NetSuite in real-time.
...
If the invocie is successfully created in NetSuite, a new field will be displayed in the Lago invoice view, providing a direct link to the corresponding NetSuite invoice.
