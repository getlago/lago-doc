...
After logging into your NetSuite account, navigate to **Setup > Users/Roles > Access Tokens > New**. Enter the required integration details and follow these steps:
- Click the **New access token** button;
- Under **Application Name**, find the integration created previously;
- Define **User** and **Role** with sufficient permissions (ideally admin);
- Provide a token **Name**; and
