...
Whenever an issue occurs in NetSuite, Lago notifies you through a [webhook message](/api-reference/webhooks/messages#param-customer-accounting-provider-error) called `customer.accounting_provider_error`.
