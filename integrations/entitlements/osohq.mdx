...
Oso offers a suitable solution for Entitlements. For more information, please refer to [Oso's documentation](https://www.osohq.com/docs).
...
## Example
[Oso's documentation](https://www.osohq.com/docs) explains the following example of entitlements properly.
