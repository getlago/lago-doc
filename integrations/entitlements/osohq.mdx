...
For more information, refer to [Oso's documentation](https://www.osohq.com/docs).
...
## Example
[Oso's documentation](https://www.osohq.com/docs) explains the following entitlements example.
