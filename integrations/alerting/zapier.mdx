...
Here is a typical use case of using Lago with Zapier to build alerting automation.
...
3. Create a field called `payload`. Its value is the full **Raw body** of the invoice object you received;
...
```
<Frame caption="Script to transform the invoice payload">
...
Once you have the breakdown of fields returned by the invoice payload, use them to build a Slack message.
