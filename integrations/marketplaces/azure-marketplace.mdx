...
If you use Lago for metering and billing and want to expand into the Azure marketplace, Lago partners with [Suger](https://suger.io) to list, transact and co-sell there.

Their no-code integration with Lago tracks usage in your existing setup and allocates it across cloud marketplaces.
You do not need to migrate your data or build the integration yourself.
