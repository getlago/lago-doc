...
3. Fill in the form
   ([learn more about billable metrics](/docs/guide/billable-metrics/overview));
   and
...
3. Fill in the form in the pop-up window
   ([learn more about customers](/docs/guide/customers)); and
4. Click **"Add customer"** to save.

You can also create customers through the API, as described in the
[documentation](/docs/api/customers/create-update-customer).
...
[documentation](/docs/api/subscriptions/create-subscription).
...
refer to the [API documentation](/docs/api/events/metered-event).
...
[API documentation](/docs/api/invoices/invoice-object).
