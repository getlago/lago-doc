...
![Active OAuth connection with GoCardless](/payments/images/gcl-oauth-65c0e5a1a2767f606b55395e0ba394e4.png)
...
![Webhook endpoint creation in GoCardless](/payments/images/gcl-webhook-9e1e96b038542112b1609ebb70a9dda9.png)
...
[API documentation](/api/webhooks/message-signature).
...
[the API](/api/customers/create-update). When adding customer information, you
must:
...
![Creation of a new customer with GoCardless](/payments/images/gcl-customer-new-3f7f52c1614edb8b577b075e35de99fb.png)

When the customer is successfully created, you will receive two
[webhook messages](/api/webhooks/messages):
...
![Migration of an existing GoCardless customer](/payments/images/gcl-customer-migration-959faab7b09d8c09866b477845ad8b3b.png)
...
![Direct debit setup with GoCardless](/payments/images/gcl-mandate-c4e336d031a583d002189188ab2599e2.png)
