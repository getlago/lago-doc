...
5. Enter the following URL:
   [https://api.getlago.com/webhook/gocardless/:id](https://api.getlago.com/webhook/gocardless/:id)
...
[API documentation](/docs/api/webhooks/message-signature).
...
[the API](/docs/api/customers/create-update-customer). When adding customer
...
[webhook messages](/docs/api/webhooks/messages):
...
[webhook](/docs/api/webhooks/messages).

tip

If you have signed up for
[GoCardless Success+](https://gocardless.com/solutions/success-plus/), failed
payments may be automatically resubmitted, in which case Lago will automatically
