...
[webhooks](/api/webhooks/messages) to collect payments, you have the ability to
...
![Payment retry via the invoice list](/payments/images/retry-payment-a34e7670c5465cd86eb660502b3aa4ce.png)
...
[Stripe](/payments/stripe-integration) or
[GoCardless](/payments/gocardless-integration), Lago will automatically process
the payment through integration.

It is also possible to trigger payment retries via the API
([learn more](/api/invoices/retry)).
