    ...
    <ResponseField name="billing_configuration" type="object">
      <Expandable title="object">
        ...
        <ResponseField name="provider_payment_methods" type="array">
          Specifies the available payment methods that can be used for this customer when `payment_provider` is set to `stripe`. 
          The `provider_payment_methods` field is an array that allows multiple payment options to be defined. If this field is not explicitly set, all the payment methods are selected.
