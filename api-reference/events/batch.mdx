...
description: "This endpoint is used for transmitting usage measurement events in batch multiple subscriptions of the same customer."
---

<Warning>
  Please be aware that charges paid in advance are not compatible with this batch events endpoint.
</Warning>
