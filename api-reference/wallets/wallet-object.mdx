    ...
    <ResponseField name="recurring_transaction_rules" type="array">
      ...
      <Expandable title="array">
        ...
        <ResponseField name="lago_id" type="string">
          Unique identifier assigned to the recurring rule within the Lago application. This ID is exclusively created by Lago and serves as a unique identifier for the recurring rule record within the Lago system. 
        </ResponseField>
