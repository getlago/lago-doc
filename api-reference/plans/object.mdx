...
<ResponseField name="plan" type="object">
  <Expandable title="object" defaultOpen="true">
    ...
    <ResponseField name="interval" type="string" required>
      The interval used for recurring billing. It represents the frequency at which subscription billing occurs. The interval can be one of the following values: `yearly`, `monthly`, or `weekly`.
    </ResponseField>
