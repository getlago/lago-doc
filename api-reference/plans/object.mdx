        ...
        <ResponseField name="properties" type="JSON">
          <Expandable>
            ...
            <ResponseField name="per_transaction_min_amount" type="string">
              Specifies the minimum allowable spending for a single transaction, defined in cents. Working as a transaction floor. Cannot be greater than the `per_transaction_max_amount` value.
            </ResponseField>
            <ResponseField name="per_transaction_max_amount" type="string">
              Specifies the maximum allowable spending for a single transaction, defined in cents. Working as a transaction cap. Cannot be lower than the `per_transaction_min_amount` value.
            </ResponseField>
