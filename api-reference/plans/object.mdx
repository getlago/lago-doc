...
```json The plan object
{
  "plan": {
    ...
    "charges": [
      ...
      {
        "lago_id": "fcdfdbd0-ded2-420b-b51f-d5c3422181a0",
        "lago_billable_metric_id": "89f2cdb6-2323-4b0f-9854-5323f432c0b6",
        "billable_metric_code": "transfers",
        "created_at": "2023-08-17T19:11:47Z",
      ...
      <Expandable title="charges">
        ...
        <ResponseField name="properties" type="JSON">
          <Expandable>
            ...
            <ResponseField name="free_units_per_events" type="integer" required>
            ...
            <ResponseField name="free_units_per_total_aggregation" type="integer" required>
            ...
            <ResponseField name="graduated_percentage_ranges" type="array" required>
              <Expandable>
                ...
                <ResponseField name="fixed_amount" type="string" required>
                  The fixed amount applies to individual events, each representing a transaction, excluding tax, for a `graduated percentage` charge model.  When a transaction spans two tiers, the Lago billing engine only charges the fixed fee of the higher tier.
                </ResponseField>
                <ResponseField name="flat_amount" type="string" required>
