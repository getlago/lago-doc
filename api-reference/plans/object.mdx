    ...
    <ResponseField name="minimum_commitment" type="object">
      <Expandable title="minimum_commitment">
        ...
        <ResponseField name="interval" type="string">
          The interval used for recurring billing. It represents the frequency at which minimum commitment billing occurs.
          Available options: `weekly`, `monthly`, `quarterly`, `yearly`.
        </ResponseField>
        <ResponseField name="created_at" type="string" required>
