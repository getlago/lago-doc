...
func main() {
	...
	organizationInput := &lago.OrganizationInput{
		...
		Timezone:                "America/New_York",
		EmailSettings:           []string{"invoice.finalized"},
		TaxIdentificationNumber: "US123456789",
		DefaultCurrency:         lago.USD,
		DocumentNumbering:       lago.DocumentNumberingPerCustomer,
		DocumentNumberPrefix:    "LAGO-INV",
		BillingConfiguration: lago.OrganizationBillingConfigurationInput{
	...
	organization, err := lagoClient.Organization().Update(ctx, organizationInput)
	if err != nil {
		// Error is *lago.Error
		panic(err)
	}
