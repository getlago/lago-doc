...
- [JavaScript client package metadata](https://registry.npmjs.org/lago-javascript-client/latest) and [source](https://github.com/getlago/lago-javascript-client)
...
- The **Lago Product MCP** is the open-source, Docker-distributed server documented in the [product MCP guide](/guide/ai-agents/mcp-server) and maintained in the [Lago Agent Toolkit repository](https://github.com/getlago/lago-agent-toolkit). It authenticates with a Lago API key and exposes live billing data and operations over stdio.
