...
Compatible agent clients can also load the repository as an [Agent Plugin](/plugin.json). Its [MCP configuration](/mcp.json) points to the same read-only Lago Docs MCP server, and its packaged billing skill is maintained in the [public Lago documentation repository](https://github.com/getlago/lago-doc/tree/main/skills/lago-billing).
