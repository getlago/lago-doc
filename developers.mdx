...
Start with [For agents](/guide/ai-agents/for-agents) for first prompts, API and CLI setup, optional plugin guidance, and advice on choosing between documentation access and live billing tools.
