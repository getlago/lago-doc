...
Start with [For agents](/guide/ai-agents/for-agents) for the Lago plugin, first prompts, CLI setup, and guidance on choosing between documentation access and live billing tools.
