...
You may delete a billable metric linked to [charges](/plans/charges) associated
with existing [subscriptions](/plans/subscription).
...
- The charges associated with this billable metric will no longer be included in
  the [current usage](/customer-usage/customer-usage-object) of the customers
  concerned; and
- The charges associated with this billable metric will be immediately removed
