...
You may delete a billable metric linked to [charges](/docs/guide/plans/charges) associated with existing [subscriptions](/docs/guide/plans/subscription).
...
* The charges associated with this billable metric will no longer be included in the [current usage](/docs/api/customer%5Fusage/customer-usage-object) of the customers concerned; and
