...
>
  ...
  [Learn more](/guide/plans/progressive-billing)
  ...
  [Learn more](/guide/invoicing/invoicing-settings/empty-invoices)
...
>
  ...
  **`2. Marking external­_subscription­_id as mandatory for events`**
  ...
  Events that only include `external­_customer­_id` are no longer taken into account when aggregating usage ([learn more](/guide/migration/migration-to-v1.2.0#2-mandatory-external_subscription_id-field-in-event-payloads)). This change will streamline the event validation process and enable real-time billing capabilities.
  ...
  **3. Removing deprecated API fields**
  ...
  [Learn more](/api-reference/webhooks/messages#param-invoice-payment-overdue)
...
>
  ...
  **2. The external subscription ID becomes mandatory for events**
  ...
  Events that only include `external_customer_id` will no longer be taken into account when aggregating usage ([learn more](/guide/migration/migration-to-v1.2.0#2-mandatory-external_subscription_id-field-in-event-payloads)).
...
>
  ...
  [Learn more](/guide/invoicing/draft-invoices#edit-an-existing-fee)
