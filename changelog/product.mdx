...
<Update label="October 2025">
  ...
  We have introduced our first **ML model** to **forecast your usage-based revenue up to 12 months ahead**. The model provides **three scenarios**: **Realistic**, **Pessimistic**, and **Optimistic**, and continuously refines its predictions based on your invoiced usage data.
