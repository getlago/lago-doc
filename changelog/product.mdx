...
<Update label="August 2026">
  ...
  <Frame>
    ![](/changelog/images/20260814-dunning-agent.png)
  </Frame>

  A dunning campaign is a timer. Day 3, day 7, day 14, the same ladder for everyone on the overdue list. It sends a past due notice to the customer who has paid on day 8 for two years. It chases the full face value of an invoice a partial payment already covered. It sends "please pay your invoice" to someone whose card simply expired. Every one of those emails costs you something, and none of them collect anything.

  The **Dunning Agent** reads the account before it writes the email. Twelve months of invoices and payments, the disputes, the credit notes, the provider status. Then it acts at the lowest rung that is justified, and if nothing is justified it does nothing and tells you why.

  - **It waits on the customers who aren't actually a problem.** It works out the median pay lag across a customer's paid invoices and whether that lag is consistent. Reliably eight days late and six days overdue is not a collections problem. No email goes out.
  - **It chases the net, never the face value.** A partial payment leaves an invoice fully `pending` at its full amount in Lago. The agent nets out payments and credit notes first, so the email, the escalation threshold, and the retry limit all work off what is actually still owed.
  - **A declined card gets a card-fix email, not a reminder.** With a self-serve portal link to update the card. Below the retry cap it re-attempts the charge itself, once, through whichever payment provider you already have connected.
  - **Large and stubborn accounts stop and go to a person.** Above the materiality line, or chased three times with no answer, the agent hands off to Slack with the reason and the recommended next step. Chasing forever is not a strategy.
  - **Every decision cites a rule and the evidence.** *"Repeat-late, 3 of 5 invoices late, 40 days overdue, so firm."* *"\$14,000, above the \$10,000 line, so a human."* An action that can't cite both never fires.

  The model drafts. Deterministic code decides. Touch caps, deduplication, and a live re-read of the invoice a moment before sending, so an invoice paid between the decision and the send is never chased. Nothing above the lowest blast radius executes without a human approving it.

  Run it as a Claude Skill against your Lago MCP connector and it drafts into Gmail for a person to send. Self-host the app and it collects.

  [Learn more](/guide/ai-agents/dunning-agent)

  <Info>
  **Beta.** Available upon request. **[Contact us](mailto:hello@getlago.com)** to get access.

  This agent acts on real customers: it sends email and re-attempts real charges. Run a dry-run sweep, read the decisions it made, and confirm the policy limits before letting it run unattended.
  </Info>

  ## Revenue Recognition: from what you billed to what you earned <Badge color="orange" shape="pill">Alpha</Badge>

  <Frame>
    ![](/changelog/images/20260813-revrec.png)
  </Frame>
  ...
  **Alpha.** Released gradually, account by account, so the figures get validated against real ledgers and real closes first. Reports, exports, and edge-case treatment can still change between releases, so reconcile the output before you rely on it for a statutory close.
  ...
  <Frame>
    ![](/changelog/images/20260812-databricks-ai-gateway.png)
  </Frame>
  ...
  **Or backfill from Databricks' own books.** Point the SDK at the `system.ai_gateway.usage` table and bill usage that already happened:
  ...
  <Frame>
    ![](/changelog/images/20260805-cloudflare-ai-gateway.png)
  </Frame>
  ...
  **Or bill from the gateway's own books.** Point the SDK at the gateway's logs and it bills Cloudflare's metered cost per call. Not our estimate of what the call cost. The number Cloudflare charged you.
  ...
  <Frame>
    ![](/changelog/images/20260805-entra-id-sso.png)
  </Frame>
...
<Update label="July 2026">
  ...
  <Frame>
    ![](/changelog/images/20260730-finance-assistant.png)
  </Frame>
  ...
  **Beta**
  ...
  <Frame>
    ![](/changelog/images/20260723-delete-draft-invoice.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20260706-multi-entity-currency.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20260707-po-number-one-off.png)
  </Frame>
...
<Update label="June 2026">
  ## Activation Rules: hold a subscription until it's ready to bill
    ...
    <Frame>
    ![](/changelog/images/20260629-activation-rule-payments.png)
  </Frame>
  ...
  **Activation Rules** put that gate in your hands. Add a rule to a subscription and it stays `incomplete` until the rule is satisfied. While it waits, no invoice is issued, no usage is billed, and nothing lands in your books. Once the rule passes, the subscription activates and bills exactly like any other. No rules means nothing changes: subscriptions activate on their start date as they always have.
  ...
  <Frame>
    ![](/changelog/images/20260619-german-einvoicing.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20260618-redesign-plan-sub.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20260615-llm-markup.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20260601-presentation-group-keys.png)
  </Frame>
...
<Update label="May 2026">
  ...
  **Wrap once. Bill forever.**
  ...
  <Frame>
    ![](/changelog/images/20260518-consolidate-multiple-subscriptions.png)
  </Frame>
...
<Update label="April 2026">
  ...
  <Frame>
    ![](/changelog/images/20260401-wallet-transaction-traceability.png)
  </Frame>
...
<Update label="March 2026">
  ...
  <Frame>
    ![](/changelog/images/20260318-wallet-alerts.png)
  </Frame>
  ...
  **Wallet alerts** let you set threshold-based notifications on any wallet, so your team and customers know exactly when credits are running low, before it becomes a problem.
  ...
  ## Security logs
  <Frame>
    ![](/changelog/images/20260309-security-logs.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20260302-new-endpoints.png)
  </Frame>
...
<Update label="February 2026">
  ...
  <Frame>
    ![](/changelog/images/20260226-payment-methods.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20260224-analytics-reports.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20260223-webhook-filters.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20260216-resend-emails.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20260212-email-logs.png)
  </Frame>
...
<Update label="January 2026">
  ...
  ## Offset unused amounts when terminating a subscription
    <Frame>
      ![](/changelog/images/20260127-terminate-sub-offset-invoice.png)
    </Frame>  
  ...
  ## Fixed charges are now available in plans
   <Frame>
    ![](/changelog/images/20260122-fixed-charge-in-plan.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20260121-credit-note-offset.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20260112-custom-roles-permissions.png)
  </Frame>
...
<Update label="December 2025">
  ...
  <Frame>
    ![](/changelog/images/20251215mcp-server.png)
  </Frame>
  ...
  **The Lago MCP Server is now available!** Securely connect your AI ecosystem to enterprise billing data.
  ...
  <Frame>
    ![](/changelog/images/20251211-issuing-date-preferences.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20251209-credit-note-metadata.png)
  </Frame>
...
This allows teams to store key operational details — such as the reason for issuing the credit note, internal notes, or synchronization references for external tools.
  ...
  <Frame>
    ![](/changelog/images/20251209-ai-agent-billing-assistant.png)
  </Frame>
...
<Update label="November 2025">
  ...
  <Frame>
    ![](/changelog/images/20251119-einvoicing.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20251119-integration-mapping-improvements.png)
  </Frame>
...
<Update label="October 2025">
  ...
  <Frame>
    ![](/changelog/images/20251029-forecasted-usage.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20251013-customers-filters.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20251006-wallet-transaction-limits.png)
  </Frame>
...
<Update label="September 2025">
  ...
  <Frame>
    ![](/changelog/images/20250924-wallet-transaction-name.png)
  </Frame>
...
<Update label="August 2025">
  ...
  <Frame>
    ![](./images/20250829-semiannual-interval.png)
  </Frame>
 ...
 <Frame>
    ![](/changelog/images/20250826-entitlements.jpg)
  </Frame>
...
[Learn more](/guide/entitlements)
  ...
  <Frame>
    ![](/changelog/images/20250821-revenue-streams-contra-revenue.png)
  </Frame>
  ...
  [Learn more](/guide/analytics/reports#finance-reports)

  ## Set service periods on one-off line items

  <Frame>
    ![](/changelog/images/20250814-billing-boundaries-one-off.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20250814-terminate-sub-cn-choice.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20250814-terminate-sub-no-invoice.png)
  </Frame>
...
## Display the projected usage of your customers
  ...
  <Frame>
    ![](/changelog/images/20250728-projected-usage.png)
  </Frame>
...
## Regenerate voided invoices
  ...
  <Frame>
    ![](/changelog/images/20250729-regenerate-voided-invoice.png)
  </Frame>
...
## Limit prepaid credits to specific billable metrics
  ...
  <Frame>
    ![](/changelog/images/20250729-prepaid-credits-scope-bm.png)
  </Frame>
 ...
 ## Get payment links for pending invoices
  ...
  <Frame>
    ![](/changelog/images/20250728-paylink-button.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20250723-pricing-units.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20250723-login-enforcement.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20250701-new-navigation.png)
  </Frame>
...
<Update label="June 2025">
  ...
  <Frame>
    ![](/changelog/images/20250625-api-logs.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20250620-pricing-group-keys.png)
  </Frame>
  **Launch Week IV, Day 5: Pricing Group Keys**
  ...
  <Frame caption="Usage-based billing with group keys">
    ![](/changelog/images/20250620-pricing-group-usage.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20250619-wallet-scopes.png)
  </Frame>
  **Launch Week IV, Day 4: Restrict Prepaid Credits to Specific Charges**
  ...
  <Frame>
    ![](/changelog/images/20250618-avalara-integration.png)
  </Frame>
  **Launch Week IV, Day 3: End Tax Guesswork — Lago x Avalara Integration**
  ...
  <Frame>
    ![](/changelog/images/20250616-activity-logs.png)
  </Frame>
  **Launch Week IV, Day 2: Billing Activity Logs**
  ...
  <Frame>
    ![](/changelog/images/20250615-alerts.png)
  </Frame>
...
<Update label="May 2025">
  ...
  <Frame>
    ![](/changelog/images/20250515-billing-entities.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20250425-analytics-prepaid-credits-flow.png)
  </Frame>
  [Learn more](/guide/analytics/reports#usage-and-credits-reports)
</Update>
...
<Update label="April 2025">
  ...
  <Frame>
    ![](/changelog/images/20250422-invoice-idempotent-checkout-url.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20250417-lago-data-pipeline.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20250415-moneyhash-integration.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20250414-revenue-streams-overview.png)
  </Frame>
...
<Update label="March 2025">
  ...
  <Frame>
    ![](/changelog/images/20250408-wallet-transaction-checkout-url.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20250407-receipt-document.png)
  </Frame>
  <Info>
  ...
  <Frame>
    ![](/changelog/images/20250324-pdf-no-generated.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20250320-wallet-transaction-details.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20250320-failed-wallet-transaction.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20250313-expirat-at-recurring-transaction-rule.png)
  </Frame>
...
<Update label="February 2025">
  ...
  <Frame>
    ![](/changelog/images/20250224-wallet-webhooks.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20250225-bank-transfers.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20250220-crypto-payments.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20250217-manual-payment.png)
  </Frame>
  <Info>
  ...
  <Frame>
    ![](/changelog/images/20250217-partner-billing.png)
  </Frame>
  <Info>
    ✨ This feature is only available via a premium license. Please contact [hello@getlago.com](mailto:hello@getlago.com) to get access to Lago Cloud and Lago Self-Hosted Premium.
  </Info>
  ...
  <Frame>
    ![](/changelog/images/20250217-invoice-previews.png)
  </Frame>
  <Info>
    ✨ This feature is only available via a premium license. Please contact [hello@getlago.com](mailto:hello@getlago.com) to get access to Lago Cloud and Lago Self-Hosted Premium.
  </Info>
...
<Update label="January 2025">
  ...
  <Frame>
    ![](/changelog/images/20250206-10-webhook-endpoints.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20250206-add-fee-draft-invoice.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20250131-retrieve-wallet-transaction.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20250127-create-customer-lago-salesforce.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20250113-custom-invoice-section.png)
  </Frame>
...
<Update label="December 2024">
  ...
  <Frame>
    ![](/changelog/images/20250102-export-credit-notes.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20241104-api-permissions.png)
  </Frame>
...
<Update label="November 2024">
  ...
  <Frame>
    ![](/changelog/images/20241128-delete-dunning-campaign.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20241126-add-api-key.png)
  </Frame>
  <Info>
  ...
  <Frame>
    ![](/changelog/images/20241126-schedule-rotate-api-keys.png)
  </Frame>
  <Info>
    ✨ This feature is only available via a premium licence. Please contact [hello@getlago.com](mailto:hello@getlago.com) to get access to Lago Cloud and Lago Self-Hosted Premium.
  </Info>
  ...
  <Frame>
    ![](/changelog/images/20241122-rotate-api-keys.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20241113-auto-dunning.gif)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20241113-rounding.png)
  </Frame>
  ...
  **Custom expressions allow you to define more advanced computation logic** by dynamically using any event field within your expression. Here are a few examples:
  ...
  <Frame>
    ![](/changelog/images/20241113-cascade-plans-edits-to-overridden-sub.png)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20241105-sync-billing-data-hubspot.jpg)
  </Frame>
  ...
  <Frame>
    ![](/changelog/images/20241105-sync-billing-data-salesforce-cpq.jpg)
  </Frame>
  ...
  **Once a quote is approved and signed, it automatically triggers a real-time subscription in Lago**.
  ...
  <Frame>
    ![](/changelog/images/20241105-dynamic-pricing.png)
  </Frame>
...
<Update label="October 2024">
  ...
  <Frame>
    ![](/changelog/images/20241031-customer-portal-rework.jpg)
  </Frame>
  ...
  **Cherry on top?** We’re offering the new Customer Portal **for free** to all users, including those on our open-source plan.
  ...
  <Frame>
    ![](/changelog/images/20241031-ingest-usage-custom-sources.jpg)
  </Frame>
