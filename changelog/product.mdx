...
<Update label="March 2025">
  ## Disable pdf generation
    ...
    If you don’t rely on our PDFs, you can now configure Lago—via an [environment variable](/guide/self-hosted/docker##environment-variables)—to skip PDF generation for invoices, credit notes, and receipts.
    Lago won’t process any jobs related to these documents, keeping your queues less crowded.

    [Learn more](../guide/invoicing/download-invoices#disable-pdf-generation)
