...
<Update label="August 2025">
  ...
  ## Do not generation invoice at subscription termination

  <Frame>
    ![](/changelog/images/20250814-terminate-sub-no-invoice.png)
  </Frame>

  Ended a subscription by mistake? Now you can close it **without generating a closing invoice**, so you don’t have to deal with invoices that were never meant to exist.
