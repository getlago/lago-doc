...
<Update label="December 2024">
  ...
  - Standard, including the list of credit notes and credit note amounts (i.e. one row per credit note)
  - Advanced, including the list of credit note line items (i.e. one row per line item, so multiple rows per credit note if it includes multiple fees)
