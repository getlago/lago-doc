...
<Update
  label="August 2026"
  tags={["AI agents", "Integrations", "Revenue recognition", "Invoicing"]}
  rss={{
    title: "August 2026 - The Dunning Agent and Revenue Recognition",
    description: "Collections that read the account before chasing, accrual revenue built from your billing data, and two new AI gateways."
  }}
>
