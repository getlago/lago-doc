...
The Go channel requires Go 1.27 or later. `lago version` prints the CLI version and the API spec version it was built from. `lago upgrade` tells you whether a newer release exists and the upgrade command for your install method.
