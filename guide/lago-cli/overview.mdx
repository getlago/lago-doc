...
Requires Go 1.27 or later. `lago version` prints the CLI version and the API spec version it was built from. `lago upgrade` tells you whether a newer release exists and the command to install it.
