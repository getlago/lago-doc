...
`SPEC_VERSION` is the Lago OpenAPI version the binary was generated from. Neither channel self-updates: `upgrade` prints `brew upgrade getlago/tap/lago` or the matching `go install` command.
