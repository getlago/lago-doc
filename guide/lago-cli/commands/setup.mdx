...
`SPEC_VERSION` is the Lago OpenAPI version the binary was generated from. The binary does not self-update: `upgrade` prints the `go install` command for the latest release.
