---
title: "Migration to v1.28.0"
---

Dear Lago Community, 👋

We're writing to inform you about important changes in Lago v1.28.0 that will enhance data consistency and prepare for upcoming features.
...
<Warning>
If you're upgrading to v1.28.0, you must complete all the migration steps below to ensure data consistency and proper functionality.
</Warning>

## Migration Steps

1. Install the new version of Lago (v1.28.0)
...
3. Run the following command:
   ...
   ```ruby
   Invoice.where("organization_sequential_id != 0")
...
We recommend performing this migration as soon as possible after the release of v1.28.0 to ensure optimal performance and access to new features.
