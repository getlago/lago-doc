...
We're writing to inform you about important changes in Lago v1.52.0 that introduce **multi-currency** and **multi-billing-entity billing on a single customer**.
