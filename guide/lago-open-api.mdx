...
1. **Copy the following link:** [http://swagger.getlago.com/swagger.yaml](http://swagger.getlago.com/swagger.yaml) (this link can also be found on the Swagger's page);
...
<Frame caption="Import Lago API documentation into Postman">
  <img src="/guide/images/import-lago-api-85b3ecf31b776f55f5c16c5829aa8ebf.png" />
</Frame>