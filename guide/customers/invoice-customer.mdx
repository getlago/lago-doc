...
## Preferred language
The default language for documents is defined at the organization level ([learn more](/guide/invoicing/invoicing-settings/overview#translate-invoices)). It can be overwritten at the customer level.
