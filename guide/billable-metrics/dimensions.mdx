...
<Tabs>
  <Tab title="Dashboard">
    1. Create a new billable metric; and
    2. Click and collapse the section **Define groups in this billable metric**; and
    3. Add your group following the json structure bellow
    ```json
    {
      "key": "provider",
