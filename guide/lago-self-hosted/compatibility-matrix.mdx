...
|---|---|---|---|
| Analytics DB | ClickHouse | 25.6+ | Required for the ClickHouse [event store](/guide/lago-self-hosted/docker#configuring-the-event-store), analytics, and activity/API/security logs |
