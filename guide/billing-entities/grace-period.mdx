...
<Frame caption="Illustration of the grace period">
  <img src="/guide/billing-entity/images/grace-period-timeline-299de2425036f803f20825e8a42ab401.png" />
</Frame>
...
<Tabs>
  ...
  <Tab title="API">
    You can also modify the entity's grace period at any time through [the API](/api-reference/billing-entity/update).
      <CodeGroup>
