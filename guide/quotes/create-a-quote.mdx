...
3. Select a **customer**;
4. Select the **currency**. If the customer already has a currency, the field is locked to it. If not, the one you pick becomes the customer's currency;
...
- **Execution details**: customer, currency, and subscription (for amendments), read-only. A **"Start date"** and **"End date"** for the deal, which you set here. The **"Payment term"**, displayed from the customer's or billing entity's net payment term.
