...
The editor works like a modern document editor. An empty line shows the hint **"Type / for commands..."**. The toolbar covers standard formatting: headings, bold and italic, colors, lists, alignment, links, tables, code blocks, and images (PNG, JPG, WEBP, GIF under 5MB). Hover a block to move or delete it. Cmd+Z restores deleted blocks.
