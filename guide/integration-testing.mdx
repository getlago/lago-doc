...
3. Fill in the form ([learn more about billable metrics](/overview)); and
...
[documentation](/api/subscriptions/create).
...
refer to the [API documentation](/api/events/metered).
...
[API documentation](/api/invoices/invoice-object).
