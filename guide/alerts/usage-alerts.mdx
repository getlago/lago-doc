---
title: "Usage alerts"
description: "Usage alerts allow you to monitor your subscriptions' usage and billing by firing notifications when certain conditions are met."
---
...
<Tabs>
  ...
  <Tab title="API">
    ...
    ```bash Billable metric usage alert creation
    LAGO_URL="https://api.getlago.com"
    API_KEY="__YOUR_API_KEY__"
...
- **Billable Metric Lifetime Usage Units** (`billable_metric_lifetime_usage_units`): Triggered when the lifetime number of units of a specific billable metric exceeds predefined thresholds.
