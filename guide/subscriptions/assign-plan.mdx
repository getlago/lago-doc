...
<Tabs>
  <Tab title="Dashboard">
    ...
    8. Choose whether the subscription should be renewed at the beginning of the period or on its anniversary date (see [below](subscription#billing-cycles)); and
...
The subscription date displayed in the app is based on the [organization's timezone](../../../changelog/timezones).
...
## Deleting a plan
You could [delete a plan](../../api/plans/destroy-plan) linked to existing subscriptions.
