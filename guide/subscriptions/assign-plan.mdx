...
Keep in mind, 15 days before the subscription ends, a webhook alert, called `alert.subscription_to_be_terminated`, will remind you. You then have two choices:
