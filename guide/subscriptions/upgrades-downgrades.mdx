...
Lago issues a credit note for the unused days remaining on the former plan.

### Paid in arrears

Lago immediately generates an invoice for the **old plan's prorated period** (days consumed before the upgrade). At the end of the billing period, a second invoice is generated for the **new plan's prorated period** (days after the upgrade).
