...
## Upgrades behavior
An upgrade takes place when the subscription fee of the new plan surpasses the subscription fee of the previous plan, 
...
## Downgrades behavior
A downgrade takes place when the subscription fee of the new plan is lower than the subscription fee of the previous plan, 
regardless of the pricing for usage-based charges.
