...
Forecasted Usage relies on a complex ML model that requires sufficient historical data to produce reliable predictions. This feature is only available for customers with <u>at least 6 months of usage data</u>. Organizations with less history will not see forecasts until enough data has accumulated.
</Warning>
