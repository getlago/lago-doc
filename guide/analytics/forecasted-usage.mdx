...
The target variable we forecast is future paid usage (as opposed to invoiced usage which may or may not be paid).
...
### Subscription growth
The model explicitly models the growth in the number of subscription using the historical data of your organization.
