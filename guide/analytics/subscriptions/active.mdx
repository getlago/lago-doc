...
Four charts. All of them count subscriptions, and none of them add up across months.
...
❌ Do not add months together. Summing twelve months would count the same subscription twelve times. For what a month added or lost, read net subscription change below.
...
✅ Monthly values add up to the yearly total.
...
❌ Do not add months together. This is a balance, like active subscriptions.
