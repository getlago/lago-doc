...
<Note>
**The Payments view is coming soon.** Cash collection currently shows [Dunnings](/guide/analytics/cash-collection/dunnings) only, so nothing on this page is in the Analytics UI yet.
</Note>
