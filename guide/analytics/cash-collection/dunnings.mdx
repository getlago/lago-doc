...
| --- | --- | --- | --- |
| Dunning outcome | How many chased invoices got paid? | #️⃣ Count | ✅ |
| Dunning revenue recovered by currency | How much came back, per currency? | 💰 (incl. tax) and #️⃣ | ❌ |
| Dunning recovery time | How fast did it come back? | #️⃣ Count | ❌ |
| Dunning attempt summary per invoice | What happened to one specific invoice? | 💰 (incl. tax) and #️⃣ | ❌ |

Recovered revenue and recovery time are a **photo of today**: one figure covering everything recovered so far, not a monthly series.
