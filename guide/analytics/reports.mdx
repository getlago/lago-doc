---
title: "Reports"
description: "Lago provides a unified analytics layer for billing, revenue, and product usage data. Finance and operations teams use it to compute, monitor, and reconcile revenue metrics."
---
...
You can also retrieve analytics datasets via the API:
...
To keep performance fast and consistent across both the UI and API, Lago caches revenue analytics.
