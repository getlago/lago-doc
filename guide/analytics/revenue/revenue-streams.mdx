...
Two charts. Both show 💰 money excluding tax, and ✅ the months add up.
...
| Wallet top-ups. They are prepaid, and counted as the credits get spent | ❌ No | [Prepaid credits](/guide/analytics/prepaid-credits) |
...
- **Wallet top-ups.** The customer prepaid, so the money is counted as they spend the credits on usage. Counting the top-up too would count it twice. See [Prepaid credits](/guide/analytics/prepaid-credits).
