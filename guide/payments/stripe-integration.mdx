...
3. Click **"Stripe"** and give this connection a name and a code;
4. Enter your Stripe API key ([locate your API key](https://support.stripe.com/questions/locate-api-keys-in-the-dashboard)); and
5. Click **"Connect to Stripe"** to confirm.
