...
If the customer does not already exist in Adyen, you can create them in Lago using either the user interface or the **[API](/api/customers/create)**. When providing customer information, please ensure the following:
...
If the customer and direct debit mandate already exist in Adyen, you can create the customer record in Lago using either the user interface or **[the API](/api/customers/create)**. Follow these steps when adding customer information:
