...
Here is the [full list of permissions](https://github.com/getlago/lago-api/blob/main/app/config/permissions/role-manager.yml) for this pre-built role.
...
Here is the [full list of permissions](https://github.com/getlago/lago-api/blob/main/app/config/permissions/role-finance.yml) for this pre-built role.
...
[This document](https://github.com/getlago/lago-api/blob/main/app/config/permissions/definition.yml) outlines all the potential permissions by object that can be assigned to a custom role.
