...
[Events](/guide/events/ingesting-events) provide information about your customers'
...
[billable metrics](/guide/billable-metrics/overview). There are 4 aggregation types:
...
| `UNIQUE_COUNT`  | Returns the number of unique values of a predefined property for incoming events | Metered or Recurring  |
