...
<Tabs>
  <Tab title="Dashboard">
      To define a grace period at the organization level via the user interface, follow these steps:
...
<Tabs>
  <Tab title="Dashboard">
    To establish a grace period at the customer level through the user interface, follow these steps:
