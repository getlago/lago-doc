...
| **🇩🇪 Germany** | XRechnung | XML only | CII or UBL 2.1 (EN 16931) | Planned |
| | ZUGFeRD 2.x | Embedded XML (PDF/A-3 with XML) | CII (UN/CEFACT) | Planned |
| **🇪🇸 Spain** | Factura-e | XML only | UBL-based | Planned |
| | VeriFactu | XML only | UBL 2.1 or CII (format-agnostic) | Planned |
| **🇮🇹 Italy** | FatturaPA | XML only | Proprietary XML | Planned |
| | SDI format | XML only | Proprietary XML | Planned |
| **🇸🇦 Saudi Arabia** | ZATCA Standard Invoice | XML only | UBL 2.1 with ZATCA extensions | Planned |
| | ZATCA Simplified Invoice | Embedded XML (PDF/A-3 with XML) | UBL 2.1 with ZATCA extensions | Planned |
