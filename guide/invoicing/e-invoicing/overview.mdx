...
| | UBL EN 16931 | XML only | UBL (EN 16931) | ✅ |
| **🇩🇪 Germany** | XRechnung | XML only | UBL (EN 16931) | ✅ |
| | ZUGFeRD 2.x | Embedded XML (PDF/A-3 with XML) | CII (UN/CEFACT) | ✅ |
...
Here is an example of a Cross Industry Invoice (CII) XML file for Factur-X in France:
```xml
