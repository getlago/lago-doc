---
title: "Overview"
description: "Define invoice look and feel per entity to match your requirements."
---

Invoicing settings impact a specific entity and all customer invoices linked to it. 
...
<Tabs>
  ...
  <Tab title="API">
      You can update the invoice footer by setting `invoice_footer` in the `billing_configuration` object of your billing entity endpoint.
      <CodeGroup>
      ```bash Update the invoice footer
      LAGO_URL="https://api.getlago.com"
      API_KEY="__YOUR_API_KEY__"
...
<Tabs>
  ...
  <Tab title="API">
      You can change the document language by setting `document_locale` in the `billing_configuration` object of your billing entity endpoint.
      <CodeGroup>
