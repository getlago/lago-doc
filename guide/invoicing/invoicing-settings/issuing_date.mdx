...
| Option | Description | Example (October billing period) |
|--------|-------------|---------------------------|
...
This setting determines what happens when an invoice is finalized **after** the anchor date (e.g., due to grace period).
