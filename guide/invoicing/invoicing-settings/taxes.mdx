...
Let your tax provider handle tax logic. Lago integrates with the providers below to automate tax calculation.

To explore these integrations or be connected to a provider, contact us.
...
1. **Billing entity** taxes apply to all fees  
2. **Customer** taxes override billing entity taxes  
