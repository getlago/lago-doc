...
If you don’t rely on our PDFs, you can configure Lago—via an [environment variable](/guide/self-hosted/docker##environment-variables)—to skip PDF generation for invoices, credit notes, and receipts.
