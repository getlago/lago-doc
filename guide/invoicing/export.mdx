...
- **Billing entity:** Filter invoices by their billing entity; and
...
The `Credit notes` list can be filtered and exported too. The behavior matches the invoice export described above, using the credit note fields.