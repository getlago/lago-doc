...
2. If there are no taxes at the customer level, Lago applies the tax objects defined at the charge and plan level; and
3. If there are no taxes at the charge or plan level, Lago applies the tax objects defined at the organization level; and
