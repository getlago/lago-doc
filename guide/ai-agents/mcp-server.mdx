...
<Frame caption="Lago MCP Server">
  <img src="/changelog/images/20251215mcp-server.webp" alt="Lago MCP server connecting an AI assistant to billing data." />
</Frame>
  ...
  "mcpServers": {
    "lago": {
      ...
      "args": [
        ...
        "-e", "LAGO_API_URL=your_lago_api_url",
...
Replace `your_lago_api_key` with your Lago API key. You can find it in the **Developers > API keys** section of your Lago dashboard. Replace `your_lago_api_url` with the API base URL for your deployment:
