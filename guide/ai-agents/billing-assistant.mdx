...
## Overview
The Billing Assistant AI Agent is a conversational assistant designed to help you manage billing operations more efficiently. Instead of navigating through multiple screens or performing repetitive tasks manually, describe what you need in plain language and let the assistant handle it for you.
...
5. **Work faster with context:** The assistant remembers your past conversations, so follow-ups keep their context.

## Getting started

### Requirements
To use the AI Agent, you need access to your Lago organization and the AI chat permission enabled for your account.
...
<Accordion title="Querying data">
    ...
    - *"How many invoices were generated last week?"*
</Accordion>
...
For operations that modify or delete data, or create important billing records, the Billing Assistant requires explicit confirmation to protect against accidental changes. Here is an example:
...
5. **Batch operation limits:** Batch operations are capped and throttled to prevent excessive load.
