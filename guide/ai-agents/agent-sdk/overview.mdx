...
<CardGroup cols={2}>
  ...
  <Card
    ...
    href="/guide/ai-agents/agent-sdk/ramp-router"
  >
    Every provider behind Router, billed on the model that actually answered and priced from Router's own catalog. Live path only.
  </Card>
</CardGroup>
