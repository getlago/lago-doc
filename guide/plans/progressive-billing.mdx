...
Lago sends a webhook notification, `subscription.usage_threshold_reached`, providing details about the subscription and the specific threshold that was exceeded.
