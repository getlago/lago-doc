...
[how to create a Billable metric](/overview) first.
...
<Tabs>
  <Tab title="Dashboard">
   1. [The Plan basic informations](#plan-structure)
      ...
      - A Plan `code`
      - A Plan `description`
   2. [The Plan model](/plans/plan-model)
      - A Plan `interval`
   ...
   3. [The additional charges](/plans/charges) for this Plan (any Billable metrics
...
(meaning there is no active [subscription](/plans/subscriptions) for this Plan).
