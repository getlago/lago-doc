...
Plans can be fully edited as long as they are not linked to a customer (i.e., no active [subscription](/guide/subscriptions/assign-plan)). Once a plan is assigned to a customer, you are able to modify the prices of the subscription or charge fees. Other settings (such as "plan interval", “pay in advance”, pro-rated charges …) cannot be edited once they are assigned to a customer.
