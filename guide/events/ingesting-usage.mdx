...
```json
{
  "external_subscription_id": "__SUBSCRIPTION_ID__" // (Required) Required only in case of multiple plans for a single customer
...
<AccordionGroup>
  ...
  <Accordion title="2. The external subscription_id">
