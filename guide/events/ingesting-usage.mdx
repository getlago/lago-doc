...
- **API call limitation:** Lago supports batching of up to 1,000 events per API call. This feature is designed to balance between high-volume data handling and system performance.
