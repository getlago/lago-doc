...
<Info>Usage analytics is part of Lago's [analytics layer](/guide/analytics/overview) and is a premium feature. The same data also powers the analytics dashboards in the UI.</Info>
