...
![Configuration of the graduated charge model](/images/graduated-charge-pricing-model-65dd3d428a7a5aaeb486e851adf029e7.png)
...
![Configuration of the package charge model](/images/package-pricing-charge-model-ff1836a27a037aaf14819bbdb70c836b.png)
...
This charge model is generally used with billable metrics that allow users to calculate the total amount of transactions (e.g. `sum` aggregation type and `amount` defined as the event property - [learn more](/docs/guide/billable-metrics/aggregation-types#2-sum)).
...
![Configuration of the percentage charge model](/images/percentage-model-b2657bc04ac57c27cfe3bc3b830fd8dc.png)
...
You may delete a charge included in a plan associated with existing [subscriptions](/docs/guide/plans/subscription).

If you do so and save the change:

* The charge will be immediately removed from all subscriptions linked to this plan;
* The charge will no longer be included in the [current usage](/docs/api/customer%5Fusage/customer-usage-object) of the customers concerned; and
...
![How to delete a charge](/images/charges-delete-e8b82428bc7fe73f40f419fb6ee88dab.png)