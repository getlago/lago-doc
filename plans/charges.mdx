...
charges relate to the [billable metrics](/docs/guide/billable-metrics/overview)
defined previously.
...
[learn more](/docs/guide/billable-metrics/aggregation-types#2-sum)).
...
[subscriptions](/docs/guide/plans/subscription).
...
- The charge will no longer be included in the
  [current usage](/docs/api/customer%5Fusage/customer-usage-object) of the
