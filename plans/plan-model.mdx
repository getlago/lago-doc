...
The plan interval corresponds to the billing period and defines when invoices are generated. In most cases, the [charges](/docs/guide/plans/charges) are also calculated according to the plan interval.
