...
are generated. In most cases, the [charges](/docs/guide/plans/charges) are also
calculated according to the plan interval.
...
3. **Yearly**: subscription fees are billed on a yearly basis and charges can be
