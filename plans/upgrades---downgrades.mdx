...
4. Select the new plan you want to assign to the customer (you can also [overwrite an existing plan](/docs/guide/plans/subscription#overwriting-a-plan)); and
5. Click **"Change plan"** to save.

You can also terminate a subscription and create a new one via the API ([learn more](/docs/api/subscriptions/terminate-subscription)).
