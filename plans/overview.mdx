...
If Billable metrics are made to measure customer usage, **Plans are made to
...
[how to create a Billable metric](/docs/guide/billable-metrics/overview) first.
...
3. [The additional charges](/docs/guide/plans/charges) for this Plan (any
   Billable metrics that have been created)
   - A Charge `model`
...
(meaning there is no active [subscription](/docs/guide/plans/subscription) for
this Plan).
