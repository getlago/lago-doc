...
| ------------------ | ------------------------------------------------------------ | ------------------- |
| **COUNT**          | COUNT(tracked\_pages)                                        | 2                   |
| **SUM**            | SUM(tracked\_pages.properties.pageviews)                     | 30                  |
| **MAX**            | MAX(tracked\_pages.properties.pageviews)                     | 20                  |
| **COUNT DISTINCT** | DISTINCT\_COUNT(tracked\_pages.properties.tracked\_user\_id) | 1                   |
