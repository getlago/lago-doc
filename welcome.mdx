...
>
  ...
  <CardGroup cols={3} >
    ...
    <Card href="https://getlago.com/docs/changelog" horizontal={false} style={{ backgroundColor: '#F5F5EF' }}>
      <div className="flex flex-col" >
        <div className="mb-4">
          <svg
            className="h-6 w-6 text-gray-900 dark:text-white"
    ...
    <Card href="https://getlago.com/blog" horizontal={false} style={{ backgroundColor: '#F5F5EF' }}>
      <div className="flex flex-col" >
        <div className="mb-4">
          <svg
            className="h-6 w-6 text-gray-900 dark:text-white"
