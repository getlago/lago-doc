...
> 
> When creating a plan, you will then be able to add a [charge](/docs/guide/plans/charges) for each region available for each provider.
...
You can also create billable metrics with dimensions [via the API](/docs/api/billable%5Fmetrics/create-billable-metric).