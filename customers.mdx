...
You can also [create and update customers](/api/customers/create-update) via the
API.
...
You can also apply [coupons](/coupons), [add-ons](/add-ons) and
...
[this endpoint](/api/customer-usage/get-current).
