...
## Wrap-up
Hybrid pricing plans are popular among SaaS, API, fintech and data companies like Segment.

With Lago, you can adapt this template to create your own hybrid pricing plan, using some of our most popular features:
