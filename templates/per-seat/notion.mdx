...
This template shows you how to build a 'fair' billing system, with charges calculated according to the number of days of use.

It suits companies whose pricing depends on persistent metrics: productivity software (number of days users are active), fintechs (number of days payment cards are active) and data platforms (number of days integrations are active).
