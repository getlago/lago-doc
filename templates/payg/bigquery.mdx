...
This template is fitted for companies, like AI or infra providers, whose pricing fully depends on usage but that wish to offer free credits for newcomers.
...
<Tabs>
  <Tab title="Dashboard">
    ...
    <Frame>
    <img src="/templates/images/bigquery-create-billable-metric.png" />
    </Frame>
  </Tab>
  <Tab title="API">
...
<Tabs>
  <Tab title="Dashboard">
    ...
    <Frame>
    <img src="/templates/images/bigquery-graduated-pricing.png" />
    </Frame>
  </Tab>
  <Tab title="API">
...
<Tabs>
  <Tab title="Dashboard">
    ...
    <Frame>
      <img src="/templates/images/bigquery-create-wallet.png" />
    </Frame>
  </Tab>
