...
<Steps>
  ...
  <Step title="Create a plan">
    ...
    Prepay usage with credits and set top-up rules in real-time for your customers.

    1. Create a customer with a unique `external_id`
    ...
    2. Then, create a wallet with the customer's `external_customer_id`,
