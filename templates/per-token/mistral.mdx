...
This template shows you how Mistral uses Lago to build a billing system based on AI tokens.
It suits Large Language Model (LLM) and Generative AI companies whose pricing varies based on the application or model used.
...
*"Prices are per 1M tokens used. You can think of tokens as pieces of words (learn more [in Mistral's model documentation](https://mistral.ai/technology/#models))."*
...
<Steps>
  ...
  <Step title="Create a plan">
    ...
    <CodeGroup>
      ```bash cURL expandable highlight={7,12-66}
