...
The value of a coupon is **not** deducted from an add-on. For more information, please review the [coupons application scope](/docs/guide/coupons#application-scope).
...
Obviously, you can also apply add-ons via the API ([learn more](/docs/api/add%5Fons/apply-add-on)).
