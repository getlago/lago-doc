...
- `organization_registered`: when you create your organization by signing up to
  Lago
...
By [opting out](/docs/guide/self-hosting/tracking#opting-out), your
organization's data won't be tracked anymore.

## Examples of collected payloads[](#examples-of-collected-payloads "Direct link to heading")

### billable_metric_created[](#billable%5Fmetric%5Fcreated "Direct link to heading")
...
### customer_created[](#customer%5Fcreated "Direct link to heading")
...
### invoice_created[](#invoice%5Fcreated "Direct link to heading")
