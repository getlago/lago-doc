...
It lets you create a customer, but also track usage and create invoices for the
same customer.
...
| **currency** `String`<br /> <sub>_ISO 4217_</sub>          | Currency of the customer - [learn more](/docs/api/resources/currencies)                                 |
...
| **timezone** `String`<br /> <sub>_TZ database_</sub>       | Timezone of the customer - [learn more](/docs/api/resources/timezones)                                  |
