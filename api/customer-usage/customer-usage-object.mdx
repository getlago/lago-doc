...
| **charge_model** `String` Not null | Model of pricing applied by the charge.See [charge documentation](/docs/guide/plans/charges#the-charge-models) for possible values |
...
| **aggregation_type** `String` Not null | Aggregation type of the billable metricSee [billable metric documentation](/docs/guide/billable-metrics/aggregation-types) for possible values |
