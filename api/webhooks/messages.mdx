...
| ------------------------------- | ---------------------------------------------- |
| **invoice** `JSON` Not nullable | [Invoice object](/api/invoices/invoice-object) |
...
| Attributes                          | Description                                                  |
| ----------------------------------- | ------------------------------------------------------------ |
| **credit_note** `JSON` Not nullable | [Credit note object](/api/credit%5Fnotes/credit-note-object) |
...
| Attributes                       | Description                                       |
| -------------------------------- | ------------------------------------------------- |
| **customer** `JSON` Not nullable | [Customer object](/api/customers/customer-object) |
...
[direct debit mandate](/payments/gocardless-integration#direct-debit).
...
| Attributes                           | Description                                                   |
| ------------------------------------ | ------------------------------------------------------------- |
| **subscription** `JSON` Not nullable | [Subscription object](/api/subscriptions/subscription-object) |
