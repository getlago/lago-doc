...
![Illustration of the grace period](/invoicing/images/grace-period-timeline-299de2425036f803f20825e8a42ab401.png)
...
![Draft invoice in the Lago app](/invoicing/images/grace-period-draft-invoice-0a9ccbd1d7dc1b87faeb5a44abf484e1.png)
...
![Grace period in the settings of the app](/invoicing/images/grace-period-organization-eabdac12832b76fd4d75c1a266244339.png)

You can modify the organization's grace period at any time through the user
interface or [the API](/api/organizations/update).
...
interface or [the API](/api/customers/create-update).

![Grace period in the customer view](/invoicing/images/grace-period-customer-19e2d76ad85f4a1af86c6d8fd0f38715.png)
