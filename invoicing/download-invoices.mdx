...
When a new invoice is `finalized`, Lago will automatically send a [webhook](/docs/api/webhooks/messages) to notify you. It will also generate a PDF file that you can download and send to your customer.
...
You can also download invoices via API ([learn more](/docs/api/invoices/download-invoice)).
